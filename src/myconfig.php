...
class immotool_myconfig {
  ...
  function load_config_expose(&$config) {
    ...
    //$config->DetailsOrder = array( 'preise', 'flaechen', 'ausstattung', 'umfeld', 'zustand', 'verwaltung' );
    //$config->TextOrder = array( 'objekt_beschr', 'lage_beschr', 'ausstatt_beschr', 'preis_beschr', 'provision_beschr', 'sonstige_angaben', 'kurz_beschr' );
