...
/**
 * An embedded view for a video of d.tube.
 *
 * @author Andreas Rudolph & Walter Wagner
 * @copyright 2009-2018, OpenEstate.org
 * @license https://www.apache.org/licenses/LICENSE-2.0.html Apache License, Version 2.0
 */
class DTubeVideo extends AbstractLinkProvider
{
    /**
     * Provider name.
     *
    ...
    {
        $frameUrl = 'https://emb.d.tube/#!/' . $linkId;
        $width = (\is_int($this->width)) ? $this->width : 560;
        $height = (\is_int($this->height)) ? $this->height : 315;

        $html = '<iframe class="openestate-video-object openestate-video-object-dtube" '
