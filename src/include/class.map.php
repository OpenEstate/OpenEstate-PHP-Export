...
class ImmoToolMap {
  ...
  function canShowForObject(&$object) {
    return isset($object['adress']['latitude']) && isset($object['adress']['longitude']) && is_numeric($object['adress']['latitude']) && is_numeric($object['adress']['longitude']);
  }
  ...
  function getLatitude(&$object) {
    return (isset($object['adress']['latitude'])) ? $object['adress']['latitude'] : null;
  }
  ...
  function getLongitude(&$object) {
    return (isset($object['adress']['longitude'])) ? $object['adress']['longitude'] : null;
  }
