...
/**
 * Implementation of the listing view for the Bootstrap3 theme.
 *
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right openestate-action-language-dropdown">
                                ...
                                foreach ($languageCodes as $lang) {
                                    ...
                                    echo '<li><a href="' . html($env->getListingUrl($languageParams)) . '" '
        ...
        if (Utils::isEmptyArray($objectIds)) {
            ...
            foreach ($view->getObjectIdsOnThisPage($objectIds) as $objectId) {
                ...
                <?php } else { ?>
                    ...
                    <div class="panel panel-default openestate-listing-item openestate-listing-detail"
                         data-openestate-object="<?= html($objectId) ?>">
                        <div class="panel-heading">
                            <h3 class="panel-title openestate-listing-detail-title">
                                <a href="<?= html($objectUrl) ?>"
                                   title="<?= html(_('Show details about this object.')) ?>">
                                    <?= html($objectTitle) ?>
                                </a>
                        ...
                        <div class="panel-body openestate-listing-detail-content">
                            <?php
                        ...
                        <div class="panel-footer openestate-listing-detail-actions">
                            <a class="openestate-action openestate-action-expose" href="<?= html($objectUrl) ?>"
                               title="<?= html(_('Show details about this object.')) ?>">
                                <i class="openestate-icon-expose"></i><?= html(\ucfirst(_('details'))) ?>
                            </a>
            ...
            if ($totalPages > 1) {
                ...
                if ($currentPage > 1) {
                    ...
                    echo '<li class=""><a class="openestate-listing-pagination-prev" '
                    ...
                    echo '<li class="disabled"><a class="openestate-listing-pagination-prev" '
                ...
                if ($currentPage < $totalPages) {
                    $params = $setPageAction->getParameters($env, $currentPage + 1);
                    echo '<li class=""><a class="openestate-listing-pagination-next" '
                        . 'href="' . html($env->getListingUrl($params)) . '" '
                        . 'data-openestate-action="' . html(Utils::getJson($params)) . '" '
                        . 'title="' . html(_('Show next page.')) . '">'
                        . '<i class="openestate-icon-right"></i></a></li>';
                } else {
                    echo '<li class="disabled"><a class="openestate-listing-pagination-next" '
                        . 'href="#" '
                        . 'title="' . html(_('Show next page.')) . '" '
                        . 'disabled>'
                        . '<i class="openestate-icon-right"></i></a></li>';
